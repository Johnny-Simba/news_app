...
import 'package:news_applicaiton/ui/home/news/news_bottom_sheet.dart';
...
class _NewsItemState extends State<NewsItem> {
            ...
            Expanded(
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 2,
                      child: Text('By: ${widget.news.author ?? ''}',style: AppStyles.medium12Grey,)),
  ...
  String timeAgo(){
    var publishedTime = DateTime.parse(widget.news.publishedAt!);
  ...
  void viewModelBottomSheet() {
    showModalBottomSheet(
        context: context,
        backgroundColor: Theme.of(context).scaffoldBackgroundColor,
        builder: (context) {
          return NewsBottomSheet(news: widget.news,);
        },);
  }
}
